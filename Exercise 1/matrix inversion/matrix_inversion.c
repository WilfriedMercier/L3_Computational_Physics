...
{
    int i, j;
    unsigned int size; //number of rows/columns of our matrices mat and inv
    float det, r;
    float **mat; //our dynamically sized matrix defined by a pointer of a pointer (2D dynamical array)
